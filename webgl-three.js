...
/* Create light */
const light = new THREE.HemisphereLight( 0xffffff, 0x080820, 1 ); // overall soft white light shining from top
scene.add( light );
...
/* Create floor */
const floorGeometry = new THREE.PlaneGeometry( 5, 5 ); // width , length
